...
## P0 - V2.1 Release
- [x] Preserve remote plans/history and archive the supplied expanded brief.
- [x] Four config-driven calendars, source/coverage boundaries and date/period separation.
- [x] Fifty-four bilingual templates and validated plain-text rendering.
- [x] Explicit opt-in, cross-channel cycle dedup, recency and active-conversation rules.
- [x] Reply/manual follow-up windows, terminal actions, cooldown and sender-rest gates.
- [x] Four new read-only CLI commands, three synthetic fixtures and PCV reference contract.
- [x] Existing 241-test baseline retained; expanded 342-test suite PASS on Python 3.11.3.
...
## P1 - Next Evidence
- [ ] Python 3.12 rerun: temp-directory access blocked; elevated review unavailable (usage limit).
