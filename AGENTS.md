...
- Read README.md, VERSION.md and TODO.md first.
- V0.1 is an on-demand local CLI, not a scheduler or an outreach sender.
...
- Run pytest, both CLI commands and wheel packaging smoke tests before publishing.
